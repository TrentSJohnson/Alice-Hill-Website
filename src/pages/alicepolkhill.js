...
export default () => {
  return (
	  <Layout> 
		...
		<p>Alice Polk Hill was the first state poet laureate of Colorado from 1919 to her death in 1921. She was a poet, 
      ...
      <Link to="/choices/lateColorado/namesake/">To Alice--My Namesake</Link><br/>        <Link to="/choices/lateColorado/notReady/">A Friends Counsel</Link><br/>
